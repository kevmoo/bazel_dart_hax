...
PUB_PACKAGE_NAME = "bazelify_hax"

# Generated automatically for package:bazelify_hax|pubspec.yaml
def bazelify():
    ...
    native.new_local_repository(
        name = "async",
        path = "/Users/kevmoo/.pub-cache/hosted/pub.dartlang.org/async-1.11.2/",
    ...
    native.new_local_repository(
        name = "html",
        path = "/Users/kevmoo/.pub-cache/hosted/pub.dartlang.org/html-0.13.0/",
    ...
    native.new_local_repository(
        name = "source_span",
        path = "/Users/kevmoo/.pub-cache/hosted/pub.dartlang.org/source_span-1.2.3/",
    ...
    native.new_local_repository(
        name = "bazelify_hax",
        path = "/Users/kevmoo/temp/bazelify_hax/",
        build_file = ".bazelify/bazelify_hax.BUILD",
    )
